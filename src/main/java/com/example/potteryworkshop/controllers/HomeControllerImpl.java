...
public class HomeControllerImpl implements HomeController {
    ...
    public String createHomeViewModel(Model model) {
        ...
        var eventViewModels = eventService.showTopEvents().stream().map(e -> new EventViewModel(e.getId(), e.getName(), e.getDuration(), e.getCost(), e.getDiscountCost(), e.getDescription(), e.getDate(), e.getImageUrl(), e.getCategoryName(), e.getDifficultyName(), e.getPotterName())).toList();
